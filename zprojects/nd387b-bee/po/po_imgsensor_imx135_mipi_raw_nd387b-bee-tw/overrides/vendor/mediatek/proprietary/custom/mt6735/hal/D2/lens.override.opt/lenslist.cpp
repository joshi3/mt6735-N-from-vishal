...
#endif
#if defined(DW9800AF)
extern PFUNC_GETLENSDEFAULT pDW9800AF_getDefaultData;
#endif
...
#if defined(S5K4H8XXSTAF)
extern PFUNC_GETLENSDEFAULT pS5K4H8XXSTAF_getDefaultData;
#endif

#if defined(S5K3L8XXSTAF)
extern PFUNC_GETLENSDEFAULT pS5K3L8XXSTAF_getDefaultData;
#endif
...
MSDK_LENS_INIT_FUNCTION_STRUCT LensList_main[MAX_NUM_OF_SUPPORT_LENS] =
{
	...
	#endif
	#if defined(DW9714AF)
		{AR1335_SENSOR_ID, DW9714AF_LENS_ID, "DW9714AF", pDW9714AF_getDefaultData},
    ...
    #endif
    #if defined(DW9800AF)
        {S5K3M2_SENSOR_ID, DW9800AF_LENS_ID, "DW9800AF", pDW9800AF_getDefaultData},
        {S5K3L8_SENSOR_ID, DW9800AF_LENS_ID, "DW9800AF", pDW9800AF_getDefaultData},
    #endif
	#if defined(AD5820AF)
	...
	#if defined(S5K4H8XXSTAF)
        {S5K4H8ST_MIPI_SENSOR_ID, S5K4H8XXSTAF_LENS_ID, "S5K4H8XXSTAF", pS5K4H8XXSTAF_getDefaultData},
	#endif

	#if defined(S5K3L8XXSTAF)
        {S5K3L8ST_MIPI_SENSOR_ID, S5K3L8XXSTAF_LENS_ID, "S5K3L8XXSTAF", pS5K3L8XXSTAF_getDefaultData},
	#endif
