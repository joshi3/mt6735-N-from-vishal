...
# Vanzo:zhangqingzhan on: Wed, 07 Dec 2016 17:24:41 +0800
# add new msensor
PRODUCT_PACKAGES += qmc6983d
# End of Vanzo: zhangqingzhan
# add for af8133i on 20170411
PRODUCT_PACKAGES += af7133ed
...
# Vanzo:hanshengpeng on: Mon, 09 Nov 2015 17:12:46 +0800
# add calibration function for user version
...
$(call inherit-product, beetec/cross-platform-packages.mk)
...
# Vanzo:yangbinbin on: Fri, 14 Oct 2016 16:20:27 +0800
# add for sunwave_fingerprinter
ifeq ($(strip $(VANZO_FINGERPRINT_USE_FPC)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
endif
ifeq ($(strip $(VANZO_SUNWAVECORP_FINGERPRINT)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwavecorp/system/bin/fpserver:system/bin/fpserver
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwavecorp/system/lib/libfpClient_sw.so:system/lib/libfpClient_sw.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwavecorp/system/lib/libfpService_sw.so:system/lib/libfpService_sw.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwavecorp/system/lib/libfpjni_sw.so:system/lib/libfpjni_sw.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwavecorp/system/lib/hw/sunwave.fingerprint.default.so:system/lib/hw/sunwave.fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwavecorp/system/lib/hw/sw_sensor.default.so:system/lib/hw/sw_sensor.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwavecorp/system/lib64/libfpClient_sw.so:system/lib64/libfpClient_sw.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwavecorp/system/lib64/libfpjni_sw.so:system/lib64/libfpjni_sw.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwavecorp/system/lib64/hw/sunwave.fingerprint.default.so:system/lib64/hw/sunwave.fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwavecorp/system/lib64/hw/sw_sensor.default.so:system/lib64/hw/sw_sensor.default.so
endif

ifeq ($(strip $(VANZO_FINGER_PRINT_SW9551)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwave/system/bin/fpserver:system/bin/fpserver
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwave/system/lib/libfpClient_sw.so:system/lib/libfpClient_sw.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwave/system/lib/libfpjni_sw.so:system/lib/libfpjni_sw.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwave/system/lib/libfpService_sw.so:system/lib/libfpService_sw.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwave/system/lib/hw/sunwave.fingerprint.default.so:system/lib/hw/sunwave.fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwave/system/lib/hw/sw_sensor.default.so:system/lib/hw/sw_sensor.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwave/system/lib64/libfpClient_sw.so:system/lib64/libfpClient_sw.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwave/system/lib64/libfpjni_sw.so:system/lib64/libfpjni_sw.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/sunwave/system/lib64/hw/sunwave.fingerprint.default.so:system/lib64/hw/sunwave.fingerprint.default.so
endif

ifeq ($(strip $(VANZO_MICROARRAY_FP32)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_32/fingerprint.default.so:system/lib/hw/fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_32/libfprint-x32.so:system/lib/libfprint-x32.so
endif

ifeq ($(strip $(VANZO_MICROARRAY_FP32_116N)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_32_116n/fingerprint.default.so:system/lib/hw/fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_32_116n/libfprint-x32.so:system/lib/libfprint-x32.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_32_116n/libma-fpservice.so:system/lib/libma-fpservice.so
endif

ifeq ($(strip $(VANZO_MICROARRAY_FP64)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_64/fingerprint.default.so:system/lib64/hw/fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_64/libfprint-x64.so:system/lib64/libfprint-x64.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_64/libma-fpservice.so:system/lib64/libma-fpservice.so
endif

ifeq ($(strip $(VANZO_MICROARRAY_FP64_116N)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_64_116n/fingerprint.default.so:system/lib64/hw/fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_64_116n/libfprint-x64.so:system/lib64/libfprint-x64.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_64_116n/libma-fpservice.so:system/lib64/libma-fpservice.so
endif

ifeq ($(strip $(VANZO_GF5216_64BIT_FINGERPRINT)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf5216/libfpjni.so:system/lib64/libfpjni.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf5216/libalgoandroid.so:system/lib64/libalgoandroid.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf5216/libfp_client.so:system/lib64/libfp_client.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf5216/libfpservice.so:system/lib64/libfpservice.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf5216/libgxfingerprint.default.so:system/lib64/hw/gxfingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf5216/libfingerprint.default.so:system/lib64/hw/fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf5216/gxFpDaemon:system/bin/gx_fpd
endif

ifeq ($(strip $(VANZO_GF3258_64BIT_FINGERPRINT)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf3258/goodixfingerprintd:system/bin/goodixfingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf3258/fingerprint.default.so:system/lib64/hw/fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf3258/libgoodixfingerprintd_binder.so:system/lib64/libgoodixfingerprintd_binder.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf3258/libgf_ta.so:system/lib64/libgf_ta.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf3258/libgf_hal.so:system/lib64/libgf_hal.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf3258/libgf_algo.so:system/lib64/libgf_algo.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf3258/libgf_ca.so:system/lib64/libgf_ca.so
endif
ifeq ($(strip $(VANZO_GF3258_32BIT_FINGERPRINT)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gf3258/goodixfingerprintd:system/bin/goodixfingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gf3258/fingerprint.default.so:system/lib/hw/fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gf3258/libgoodixfingerprintd_binder.so:system/lib/libgoodixfingerprintd_binder.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gf3258/libgf_ta.so:system/lib/libgf_ta.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gf3258/libgf_hal.so:system/lib/libgf_hal.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gf3258/libgf_algo.so:system/lib/libgf_algo.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gf3258/libgf_ca.so:system/lib/libgf_ca.so
endif
ifeq ($(strip $(VANZO_GF5116M_FINGERPRINT)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf5116m/gx_fpd:system/bin/gx_fpd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf5116m/fingerprint.default.so:system/lib64/hw/fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf5116m/libfp_client.so:system/lib64/libfp_client.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf5116m/libfpalgorithm.so:system/lib64/libfpalgorithm.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf5116m/libfphal.so:system/lib64/libfphal.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gf5116m/libfpservice.so:system/lib64/libfpservice.so
endif
ifeq ($(strip $(VANZO_GX368_OTP_64BIT_FINGERPRINT)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gx368-otp/gx_fpd:system/bin/gx_fpd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gx368-otp/fingerprint.default.so:system/lib64/hw/fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gx368-otp/gxfingerprint.default.so:system/lib64/hw/gxfingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gx368-otp/libfp_client.so:system/lib64/libfp_client.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gx368-otp/libalgoandroid.so:system/lib64/libalgoandroid.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gx368-otp/libfpservice.so:system/lib64/libfpservice.so
endif
ifeq ($(strip $(VANZO_GX368_OTP_32BIT_FINGERPRINT)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gx368-otp/gx_fpd:system/bin/gx_fpd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gx368-otp/fingerprint.default.so:system/lib/hw/fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gx368-otp/gxfingerprint.default.so:system/lib/hw/gxfingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gx368-otp/libfp_client.so:system/lib/libfp_client.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gx368-otp/libalgoandroid.so:system/lib/libalgoandroid.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gx368-otp/libfpservice.so:system/lib/libfpservice.so
endif
ifeq ($(strip $(VANZO_GOODIX_GX556_64BIT)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gx556/gx_fpd:system/bin/gx_fpd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gx556/fingerprint.default.so:system/lib64/hw/fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gx556/gxfingerprint.default.so:system/lib64/hw/gxfingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gx556/libfp_client.so:system/lib64/libfp_client.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gx556/libalgoandroid.so:system/lib64/libalgoandroid.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm64-gx556/libfpservice.so:system/lib64/libfpservice.so
endif
ifeq ($(strip $(VANZO_GOODIX_GX556_32BIT)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gx556/gx_fpd:system/bin/gx_fpd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gx556/fingerprint.default.so:system/lib/hw/fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gx556/gxfingerprint.default.so:system/lib/hw/gxfingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gx556/libfp_client.so:system/lib/libfp_client.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gx556/libalgoandroid.so:system/lib/libalgoandroid.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gx556/libfpservice.so:system/lib/libfpservice.so
endif
# cdfinger
ifeq ($(strip $(VANZO_FPS_FPS998_32)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps/cdfingerdaemon:system/bin/cdfingerdaemon
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps/libcfp_proxy.so:system/lib/libcfp_proxy.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps/libcfpalgo_x56.so:system/lib/libcfpalgo_x56.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps/libcfpalgo_x70.so:system/lib/libcfpalgo_x70.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps/libcfpalgo_x98.so:system/lib/libcfpalgo_x98.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps/libcfpservice.so:system/lib/libcfpservice.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps/cdfinger.default.so:system/lib/hw/cdfinger.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps/fingerprint.default.so:system/lib/hw/fingerprint.default.so 
endif
ifeq ($(strip $(VANZO_FPS_FPS998_64)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps/lib64/cdfingerdaemon:system/bin/cdfingerdaemon
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps/lib64/libcfp_proxy.so:system/lib64/libcfp_proxy.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps/lib64/libcfpalgo_x70.so:system/lib64/libcfpalgo_x70.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps/lib64/libcfpalgo_x98.so:system/lib64/libcfpalgo_x98.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps/lib64/libcfpservice.so:system/lib64/libcfpservice.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps/lib64/cdfinger.default.so:system/lib64/hw/cdfinger.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps/lib64/fingerprint.default.so:system/lib64/hw/fingerprint.default.so 
endif
ifeq ($(strip $(VANZO_FPS_FPS998_TEE_32)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps_tee/cdfingerdaemon:system/bin/cdfingerdaemon
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps_tee/06bf3e2d-6be3-a45b-05d4c67c7e8afb1f.ta:system/app/t6/06bf3e2d-6be3-a45b-05d4c67c7e8afb1f.ta
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps_tee/libcfp_proxy.so:system/lib/libcfp_proxy.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps_tee/libcfpservice.so:system/lib/libcfpservice.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps_tee/cdfinger.default.so:system/lib/hw/cdfinger.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps_tee/cdfinger.fingerprint.default.so:system/lib/hw/cdfinger.fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps_tee/fingerprint.default.so:system/lib/hw/fingerprint.default.so
endif
ifeq ($(strip $(VANZO_FPS_FPS998_TEE_64)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps64_tee/cdfingerdaemon:system/bin/cdfingerdaemon
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps64_tee/06bf3e2d-6be3-a45b-05d4c67c7e8afb1f.ta:system/app/t6/06bf3e2d-6be3-a45b-05d4c67c7e8afb1f.ta
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps64_tee/libcfp_proxy.so:system/lib/libcfp_proxy.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps64_tee/libcfpservice.so:system/lib/libcfpservice.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps64_tee/cdfinger.default.so:system/lib/hw/cdfinger.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps64_tee/cdfinger.fingerprint.default.so:system/lib/hw/cdfinger.fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fps64_tee/fingerprint.default.so:system/lib/hw/fingerprint.default.so
endif

ifeq ($(strip $(VANZO_ELAN_32)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/elan/elan.fingerprint.default.so:system/lib/hw/elan.fingerprint.default.so
endif
ifeq ($(strip $(VANZO_ELAN_TEE_32)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/elan_tee/elan.fingerprint.default.so:system/lib/hw/elan.fingerprint.default.so
endif
ifeq ($(strip $(VANZO_BLESTECH_FP32)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/blestech/fingerprint.default.so:system/lib/hw/fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/blestech/libBtlAlgo.so:system/lib/libBtlAlgo.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/blestech/libBtlFpHal.so:system/lib/libBtlFpHal.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/blestech/libxuFPAlg.so:system/lib/libxuFPAlg.so
endif
ifeq ($(strip $(VANZO_BLESTECH_TEE_FP32)), yes)
    PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
    PRODUCT_PACKAGES += fingerprintd
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/blestech_tee/blestech.fingerprint.default.so:system/lib/hw/blestech.fingerprint.default.so
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/blestech_tee/libBtlFpHal.so:system/lib/libBtlFpHal.so
	PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/blestech/libxuFPAlg.so:system/lib/libxuFPAlg.so
endif

# End of Vanzo: yangbinbin
ifeq ($(strip $(MTK_AUDIO_SPEAKER_PATH)),smartpa_nxp_tfa9890)
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/nxp/tfa98xx_2_10_1_r4/tfa98xx_test.cnt:system/etc/tfa9890_v2.cnt
endif
ifeq ($(strip $(VANZO_FPSENSOR_64BIT_FINGERPRINT)), yes)
	PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
	PRODUCT_PACKAGES += fingerprintd
	PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fpsensor/lib64/fingerprint.default.so:system/lib64/hw/fingerprint.default.so
	PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fpsensor/lib64/fpsensor_module.default.so:system/lib64/hw/fpsensor_module.default.so
endif
ifeq ($(strip $(VANZO_FPSENSOR_32BIT_FINGERPRINT)), yes)
	PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
	PRODUCT_PACKAGES += fingerprintd
	PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fpsensor/lib/fpsensor_fingerprint.default.so:system/lib/hw/fpsensor_fingerprint.default.so
	PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fpsensor/lib/fpsensor_module.default.so:system/lib/hw/fpsensor_module.default.so
endif
