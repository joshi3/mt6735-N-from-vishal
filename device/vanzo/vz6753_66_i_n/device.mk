...
# Vanzo:tanglei on: Sat, 27 May 2017 10:40:56 +0800
#ifeq ($(BUILD_GMS),yes)
...
# PRODUCT_COPY_FILES += device/vanzo/vz6753_66_i_n/egl.cfg:$(TARGET_COPY_OUT_VENDOR)/lib/egl/egl.cfg:mtk
# PRODUCT_COPY_FILES += device/vanzo/vz6753_66_i_n/ueventd.mt6735.rc:root/ueventd.mt6735.rc

PRODUCT_COPY_FILES += device/vanzo/vz6753_66_i_n/factory_init.project.rc:root/factory_init.project.rc
PRODUCT_COPY_FILES += device/vanzo/vz6753_66_i_n/init.project.rc:root/init.project.rc
PRODUCT_COPY_FILES += device/vanzo/vz6753_66_i_n/meta_init.project.rc:root/meta_init.project.rc

ifeq ($(MTK_SMARTBOOK_SUPPORT),yes)
PRODUCT_COPY_FILES += device/vanzo/vz6753_66_i_n/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl:mtk \
                      device/vanzo/vz6753_66_i_n/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm:mtk
endif
...
ifeq ($(TARGET_BUILD_VARIANT),eng)
    PRODUCT_COPY_FILES += device/vanzo/vz6753_66_i_n/thermal_6753_eng.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/thermal.conf:mtk
else
    PRODUCT_COPY_FILES += device/vanzo/vz6753_66_i_n/thermal_6753.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/thermal.conf:mtk
endif

PRODUCT_COPY_FILES += device/vanzo/vz6753_66_i_n/thermal.wfd.6753.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_00:mtk
...
PRODUCT_COPY_FILES += device/vanzo/vz6753_66_i_n/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/vz6753_66_i_n/factory/res/sound/testpattern1.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/testpattern1.wav:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/vz6753_66_i_n/factory/res/sound/ringtone.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/ringtone.wav:mtk

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt6735/ACCDET.kl:system/usr/keylayout/ACCDET.kl:mtk
PRODUCT_COPY_FILES += device/vanzo/vz6753_66_i_n/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl:mtk

# Microphone
PRODUCT_COPY_FILES += device/vanzo/vz6753_66_i_n/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/vanzo/vz6753_66_i_n/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# Audio Policy
PRODUCT_COPY_FILES += device/vanzo/vz6753_66_i_n/audio_policy.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy.conf:mtk

#Images for LCD test in factory mode
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/vz6753_66_i_n/factory/res/images/lcd_test_00.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_00.png:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/vz6753_66_i_n/factory/res/images/lcd_test_01.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_01.png:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/vz6753_66_i_n/factory/res/images/lcd_test_02.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_02.png:mtk

# CTS Video
PRODUCT_COPY_FILES += device/vanzo/vz6753_66_i_n/media_codecs_performance.xml:system/etc/media_codecs_performance.xml:mtk

# overlay has priorities. high <-> low.

DEVICE_PACKAGE_OVERLAYS += device/mediatek/common/overlay/sd_in_ex_otg

DEVICE_PACKAGE_OVERLAYS += device/vanzo/vz6753_66_i_n/overlay
...
#$(call inherit-product-if-exists, vendor/vanzo/libs/$(MTK_TARGET_PROJECT)/device-vendor.mk)
prevent_replace_label=6753_66_i_n
