...
$(call inherit-product, device/vanzo/vz6735m_35g_i_n/device.mk)
...
PRODUCT_NAME := full_vz6735m_35g_i_n
PRODUCT_DEVICE := vz6735m_35g_i_n
PRODUCT_MODEL := vz6735m_35g_i_n
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= vz6735m_35g_i_n_debug_defconfig
else
KERNEL_DEFCONFIG ?= vz6735m_35g_i_n_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= vz6735m_35g_i_n
LK_PROJECT ?= vz6735m_35g_i_n
TRUSTY_PROJECT ?= vz6735m_35g_i_n
