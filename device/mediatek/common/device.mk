...
# Telephony
# Vanzo:yucheng on: Thu, 27 Apr 2017 20:45:58 +0800
# we will use our global version(defined within public-binary) or customer's version
...
# Vanzo:yucheng on: Tue, 27 Sep 2016 17:50:03 +0800
# Modified for security keys customization
#    ifeq ($(wildcard device/mediatek/common/security/$(strip $(MTK_TARGET_PROJECT))),)
    ifeq ($(wildcard device/mediatek/common/security/vanzo),)
# End of Vanzo: yucheng
...
#      PRODUCT_DEFAULT_DEV_CERTIFICATE := device/mediatek/common/security/$(strip $(MTK_TARGET_PROJECT))/releasekey
      PRODUCT_DEFAULT_DEV_CERTIFICATE := device/mediatek/common/security/vanzo/releasekey
# End of Vanzo: yucheng
    endif
  else
...
# GMS interface
# Vanzo:hanshengpeng on: Mon, 28 Dec 2015 15:38:29 +0800
# modify for vanzo custom google by hanshengpeng
#ifdef BUILD_GMS
...
# Vanzo:yucheng on: Fri, 23 Sep 2016 21:01:35 +0800
# system porting, to copy customized ProjectConfig.mk
