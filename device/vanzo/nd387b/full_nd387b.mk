...
$(call inherit-product, device/vanzo/nd387b/device.mk)
...
PRODUCT_NAME := full_nd387b
PRODUCT_DEVICE := nd387b
PRODUCT_MODEL := nd387b
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= nd387b_debug_defconfig
else
KERNEL_DEFCONFIG ?= nd387b_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= nd387b
LK_PROJECT ?= nd387b
TRUSTY_PROJECT ?= nd387b
