...
PRODUCT_NAME := full_vz6737m_35g_i_n
PRODUCT_DEVICE := vz6737m_35g_i_n
PRODUCT_MODEL := vz6737m_35g_i_n
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= vz6737m_35g_i_n_debug_defconfig
else
KERNEL_DEFCONFIG ?= vz6737m_35g_i_n_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= vz6737m_35g_i_n
LK_PROJECT ?= vz6737m_35g_i_n
TRUSTY_PROJECT ?= vz6737m_35g_i_n
