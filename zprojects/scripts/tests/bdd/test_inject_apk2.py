...
@scenario('inject_apk.feature', 'New config have corresponding src files')
def test_2():
    pass
...
@given('there is vanzo/cross-platform-packages.mk under source')
def src_cpp(site):
    with open('vanzo/cross-platform-packages.mk', 'w') as outf:
