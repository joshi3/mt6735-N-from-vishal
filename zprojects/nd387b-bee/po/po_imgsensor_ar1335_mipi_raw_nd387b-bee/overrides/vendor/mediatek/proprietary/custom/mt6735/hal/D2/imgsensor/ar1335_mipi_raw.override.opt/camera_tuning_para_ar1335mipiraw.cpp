...
#include "camera_AE_PLineTable_ar1335mipiraw.h"
#include "camera_info_ar1335mipiraw.h"
...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            5080000, -2140000, -380000, -880000, 3822500, -382500, -540000, -2317500, 5420000
        },
        {  // i4P10[9]
            1461042, -1546887, 85845, -176707, 227935, -51227, 443009, 561566, -1011617
        },
        {  // i4P01[9]
            899428, -1034045, 134617, -285254, -45430, 330684, 34871, -120184, 82443
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
        ...
        // rCCTConfig
        {
            ...
            //rMeteringSpec
            {
                ...
                //rABL_Spec
                {
                    ...
                    200,//u4Pcent
                    160,//u4Thd
                    150, // center luminance
                    150, // final target limitation, 256/128 = 2x
                    //sFgBgEVRatio
                    {
                        2200, //i4X1
                        0,    //i4Y1
                ...
                // rTOUCHFD_Spec
                {
                    38, //uMeteringYLowBound;
                    47, //uMeteringYHighBound;
                    38, //uFaceYLowBound;
                    47, //uFaceYHighBound;
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    ...
                    93,    // PCloudyLeftBound
                    -322,    // PCloudyUpperBound
                    -438    // PCloudyLowerBound
                },
                // Shade
                {
                    368,    // PShadeRightBound
                    93,    // PShadeLeftBound
                    -322,    // PShadeUpperBound
                    -438    // PShadeLowerBound
                },
                // Twilight
                {
                    -29,    // PTwiRightBound
                ...
                // Warm fluorescent
                {
                    -181,    // PWFluoRightBound
                    -381,    // PWFluoLeftBound
                    -332,    // PWFluoUpperBound
                    -504    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -181,    // PIncaRightBound
