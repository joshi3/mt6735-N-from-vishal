...
#define BL229X_GET_ID	             _IOWR(BF_IOCTL_MAGIC_NO, 9, u32)
#define BL229X_ENBACKLIGHT           _IOW(BF_IOCTL_MAGIC_NO, 13, u32)
#define BL229X_ISBACKLIGHT           _IOWR(BF_IOCTL_MAGIC_NO, 14, u32)
...
extern void ili9881_lcm_on(void);
extern void ili9881_lcm_off(void);
